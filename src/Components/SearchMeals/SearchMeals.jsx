...
import banner_img from '../../assets/images/banner1.png';
...
const backgroundStyle = {
    ...
    height: '32rem', // Set your custom height here
    width: '98.93vw'
}
    ...
    return (
        <section>
            <div className='md:h-96 sm:h-72 h-64 flex align-middle justify-center'
                ...
                {/* Title */}
                <div className='m-auto sm:space-y-5 space-y-3 md:w-[30rem] sm:w-[20rem]'>
